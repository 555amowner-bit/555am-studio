  ...
  return (
    <main>
      <section className="site-container py-16 sm:py-20 md:py-24 lg:py-32">
        <div className="grid-12 items-center gap-y-14 md:gap-y-0">
          <div className="col-span-12 md:col-span-7 xl:col-span-6">
            ...
            <p className="text-large mt-8 max-w-[34rem] text-stone">
              We design and build thoughtful websites for local businesses — focused on
            ...
            <div className="mt-9 flex flex-wrap items-center gap-x-6 gap-y-4">
              ...
              <Link href="/work" className="text-link">
                See our work <span className="button-arrow" aria-hidden="true">→</span>
              </Link>
            </div>
          </div>

          <div className="col-span-12 md:col-span-5 xl:col-start-7 xl:col-span-6">
            <div
